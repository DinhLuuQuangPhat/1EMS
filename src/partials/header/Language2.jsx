  ...
  return (
    <div className="inline-flex ml-3 language-switch relative">
      ...
      <Transition
        ...
        className="lg:origin-top-right left-0 z-10 absolute top-full right-0 min-w-8.75 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        show={dropdownOpen}
      ...
      >
        {/* <div
          ...
          > */}
        <div
          className="example-config z-50 w-full p-1 rounded transition ease-out duration-200 transform"
          ref={dropdown}

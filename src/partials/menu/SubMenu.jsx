  ...
  return (
    <li key={data.PRCSCODE}>
      <button
        ...
        className="flex items-center justify-start w-full py-1 text-left text-xs text-white-700 hover:text-[#ff9f3e] hover:font-semibold transition-pl-2 duration-200 ease-linear font-medium"

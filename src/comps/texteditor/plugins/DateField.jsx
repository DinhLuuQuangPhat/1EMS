...
import {CntnField} from "./CntnField";

const Embed = Quill.import('blots/embed');

export class DateField extends Embed {
  static blotName = EditorContentType.DATE_COL.blotName;
  static tagName = EditorContentType.DATE_COL.blotName;

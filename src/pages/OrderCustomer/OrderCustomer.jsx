        ...
        <div className="w-full md:flex-row flex-col">
          ...
          >
            ...
            >
                  ...
                  <div className="wrapper lg:flex lg:justify-between flex-none gap-4">
                      ...
                      <div className="wrapper-item">
                        ...
                        {/* <WrapperItem>
                          ...
                          <Input
                            ...
                            style={{ borderColor: "grey" }}
                            value={
                              JSON.parse(localStorage.getItem("userData")).EMPLNAME
                            }
                            type="text"
                            disabled={true}
                            className={appColors.inputColor}
                    ...
                    <div className="lg:w-1/3 w-full">
                      <div className="wrapper-item">
                        ...
                        {/* Phuong thuc Thanh toan PAY_MTHD */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "20")
                          .DATAVIEW === 1 && (
                          <div className="mb-3">
                            <FieldEditCombobox
                              title={getLabelValue(
                        ...
                        {/* Thong tin Ky han thanh toan PYMNNUMB, PYMNPERD*/}
                        {DcmnViewDDH.find((item) => item.DATACODE === "21")
                          .DATAVIEW === 1 && (
                          <WrapperItem>
                            <Label
                              className="text-sm"
                        ...
                        {/* Thong tin ve Xuat hoa don VAT_OUPT, VAT_CUST, VAT_ADDR, TAX_CODE */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "19")
                          .DATAVIEW === 1 && (
                          <div>
                            {/* Xuat hoa don ? VAT_OUPT */}
                    ...
                    <div className="lg:w-1/3 w-full">
                      <div className="wrapper-item">
                        {/* Nguoi nhan hang RCVREMPL */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "14")
                          .DATAVIEW === 1 && (
                          <FieldWrapper className="w-full mb-3">
                            <Label
                              className="text-sm"
                        ...
                        {/* So dien thoai nhan hang RCVR_TEL */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "14")
                          .DATAVIEW === 1 && (
                          <FieldWrapper className="w-full mb-3">
                            <Label
                        ...
                        {/* Tinh/ Thanh pho DLVRPRVN */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "15")
                          .DATAVIEW === 1 && (
                          <FieldEditCombobox
              ...
              {(DcmnViewDDH.find((item) => item.DATACODE === "13").DATAVIEW ===
                1 ||
                DcmnViewDDH.find((item) => item.DATACODE === "18").DATAVIEW ===
                  1 ||
                DcmnViewDDH.find((item) => item.DATACODE === "17").DATAVIEW ===
                  1 ||
                DcmnViewDDH.find((item) => item.DATACODE === "16").DATAVIEW ===
                  1) && (
                <TabStripTab title={getLabelValue(106, "Thông tin Giao hàng")}>
                  <div className="wrapper lg:flex lg:justify-between flex-none gap-4">
                    <div className="lg:w-1/2 w-full">
                      <div className="wrapper-item">
                        {/* Ngay gio giao hang DLVRDATE, DLVRHOUR */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "13")
                          .DATAVIEW === 1 && (
                          <div className="w-full mb-3">
                        ...
                        {/* Phuong thuc giao hang DLVRMTHD */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "17")
                          .DATAVIEW === 1 && (
                          <div className="w-full mb-3">
                            <FieldEditCombobox
                        ...
                        {/* Phuong thuc van chuyen DLVRTYPE */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "17")
                          .DATAVIEW === 1 && (
                          <div className={"w-full mb-3"}>
                            <FieldEditCombobox
                    ...
                    <div className="lg:w-1/2 w-full">
                      <div className="wrapper-item">
                        {/* Dia diem giao DLVRADDR */}
                        {DcmnViewDDH.find((item) => item.DATACODE === "16")
                          .DATAVIEW === 1 && (
                          <div className="mb-3">
                            <FieldEditCombobox

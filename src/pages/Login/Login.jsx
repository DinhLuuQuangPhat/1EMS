...
import { comCodeCommon, staticToken, apiUrl } from "../../constants";
import api from "../../api";
...
const Login = () => {
  const { setLocations, getLabelValue, setPasswordGlobal } = useStateContext();
  ...
  const handelLoginCompany = () => {
    api(localStorage.getItem("usertoken"))
      ...
      .then((res) => {
        ...
        localStorage.setItem("DSBRCODE", returnData.USERLGIN.DSBRCODE);
